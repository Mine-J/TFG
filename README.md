...
La guia incluye baseline publica y escenarios autenticados documentados para cesta, pedidos, panel de farmacia, SSE y operaciones sobre base de datos.

### Resultados obtenidos

La tabla siguiente corresponde al escenario publico inicial y debe interpretarse como resultado parcial.
...
| Tasa de fallos            | 0%     |
| Tiempo medio de respuesta | 217 ms |
| p(95)                     | 861 ms |
